        ...
        <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16 pb-8 md:pb-16 lg:pb-20 flex flex-col sm:flex-row justify-between items-center sm:items-end gap-4 sm:gap-0">
          ...
          <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-3 sm:gap-6 items-center w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-neon-orange text-black font-black rounded-full hover:bg-black hover:text-neon-orange transition-all text-sm sm:text-base uppercase tracking-tight shadow-[4px_4px_0px_0px_rgba(0,0,0,0.3)]"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-transparent text-white font-black rounded-full hover:bg-white/10 transition-all border-2 border-neon-orange text-sm sm:text-base uppercase tracking-tight"
            >
